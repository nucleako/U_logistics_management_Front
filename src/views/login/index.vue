  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="left">
      ...
      <div style="position:relative">
        <div class="tips">
          <p>Username : 3-8 digit alphanumeric combination</p>
          <p>Password : Cannot be less than 6 digits.</p>
        </div>
    ...
    <el-dialog title="关于" :visible.sync="showDialog">
      <social-sign />
    </el-dialog>
  </div>
</template>
