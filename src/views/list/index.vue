<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button
        class="filter-item"
        style="margin-left: 3px;width:90px; margin-right:10px"
    ...
    <pagination v-show="total>0" style="position:relative;top:-30px;" :total="total" :page.sync="listQuery.page" :limit.sync="listQuery.pageSize" @pagination="getList" />
    <!-- 新增或删除弹出的模态框 -->
